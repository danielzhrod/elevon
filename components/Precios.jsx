  ...
  const plans = [
    {
      ...
      items: [
        ...
        'Diseño personalizado adaptado a tus colores corporativos y logotipo',
        '100% optimizado para móvil y tablet',
    ...
    },
    {
      ...
      items: [
        ...
        'Formación incluida: sesión de 1h por videollamada para aprender a gestionar tu sistema',
